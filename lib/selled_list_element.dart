...
class SelledListPage extends StatefulWidget {
  @override
  _SelledListPage createState() => _SelledListPage();
}

class _SelledListPage extends State<SelledListPage> {
  late Query _ref;
  ...
  _showDeleteDialog({Map? radioList}) {
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text("Usunąć ${radioList!['markaModel']} ?"),
            content: Text("Czy jesteś pewien aby to usunąć ?"),
            actions: [
              Padding(
